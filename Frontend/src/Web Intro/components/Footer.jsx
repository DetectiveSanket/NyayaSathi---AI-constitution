  ...
  return (
        ...
        <div className="container mx-auto px-6 py-16">
            ...
            <div>
                ...
                <li>
                    <a href="#features" className="text-gray-400 hover:text-purple-400 transition-colors duration-200 hover:shadow-lg hover:scale-105" >Features</a>
                </li>
                <li>
                    <a href="#" className="text-gray-400 hover:text-purple-400 transition-colors duration-200 hover:shadow-lg hover:scale-105" >Dashboard</a>
                </li>
                <li>
                    <a href="#" className="text-gray-400 hover:text-purple-400 transition-colors duration-200 hover:shadow-lg hover:scale-105" >Analytics</a>
                </li>
                <li>
                    <a href="#" className="text-gray-400 hover:text-purple-400 transition-colors duration-200 hover:shadow-lg hover:scale-105" >Integrations</a>
                </li>
                <li>
                    <a href="#" className="text-gray-400 hover:text-purple-400 transition-colors duration-200 hover:shadow-lg hover:scale-105" >API</a>
                </li>
                </ul>
            ...
            <div>
                ...
                <ul className="space-y-3">
                <li><a href="#about" className="text-gray-400 hover:text-purple-400 transition-all duration-200">About</a></li>
                <li><a href="#Blog" className="text-gray-400 hover:text-purple-400 transition-all duration-200">Blog</a></li>
                <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-all duration-200">Careers</a></li>
                <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-all duration-200">Press</a></li>
                <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-all duration-200">Partners</a></li>
